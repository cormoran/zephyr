...
#define TIMER_IRQ_CONNECT(idx)                                                                     \
	COND_CODE_1(DT_INST_PROP(idx, zli),                                                        \
		    (IRQ_DIRECT_CONNECT(DT_INST_IRQN(idx), DT_INST_IRQ(idx, priority),             \
					counter_timer##idx##_isr_wrapper, IRQ_ZERO_LATENCY)),      \
		    (IRQ_CONNECT(DT_INST_IRQN(idx), DT_INST_IRQ(idx, priority), irq_handler,       \
